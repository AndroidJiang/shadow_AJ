...
final public class Constant {
    ...
    public static final String PLUGIN_APP_NAME = "shadow-plugin";
    ...
    public static final String PART_KEY_PLUGIN_BASE = "shadow-plugin";  //part-key  和 plugin-app  build.gradle中一致
